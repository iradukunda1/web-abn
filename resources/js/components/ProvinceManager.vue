    ...
    <div>
        <div class="card">
            <div class="card-body table-responsive">
                ...
                >
                    <thead>
                        <tr>
                            ...
                            <th>Country</th>
                            <th>Province</th>
                            <th v-if="users.role">District</th>
                            <th>Verified</th>
                            <th>Created</th>
                            <th>Modify</th>
                        </tr>
                    ...
                    <tbody>
                        <tr v-for="(user, index) in users" :key="user.id">
                            ...
                            <td>{{ user.country }}</td>
                            <td :class="user.user_address != null && user.user_address.province != null ? '' :'text-danger'">{{ user.user_address != null && user.user_address.province != null ? user.user_address.province : 'not-set'   }}</td>
                            <td>
                                <a
                                    href="#"
                ...
                <div class="alert alert-info" v-else>No Province Manager List yet</div>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        loadUsers() {
            axios.get("/admin/api/users?role=reporter_1").then((resp) => {
