            ...
            <div class="row">
                ...
                <div class="col col-md-4">
                    <div class="form-group">
                        ...
                        <select name="category_id" id="" class="form-control" placeholder="" required>
                            <option></option>
                            @foreach ($categories as $category )
                            <option {{ $category->id == $stock_edit->category_id ? 'selected' : '' }}value="{{
                                $stock_edit->category_id }}">{{ $category->name }}</option>
                            @endforeach
                        </select>
