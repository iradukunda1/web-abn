...
<div class="topbar">
    ...
    <div class="topbar-left">
        <a href="#" class="logo">
            <span>
                {{-- <h6 style="width: 15%;">Stock Management</h6> --}}
                <img src="/img/abn_ico.png" alt="logo-small" style="width: 15%;">
            </span>
            {{-- <span>
        ...
        <ul class="list-unstyled topbar-nav float-right mb-0">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#"
                    ...
                    <img alt="User-Profile-Image" class="img-radius" src="{{auth()->user()->avatar}}"
                        style="height: 40px">
                    @else
                    <img alt="User-Profile-Image" class="img-radius" src="/img/user.png" style="height: 40px">
                    @endif

                    <span class="ml-1 nav-user-name hidden-sm"><span>{{ auth()->user()->email }}</span><i
